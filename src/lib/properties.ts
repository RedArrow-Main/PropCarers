...
export interface MaintenanceTransaction {
  ...
  month: string;
  description: string;
  workStatus: "Completed" | "Un-Complete" | "In Progress";
  billStatus: "Paid" | "Un-Paid";
  billAmount: number;
}
...
export const maintenanceTransactions: Record<number, MaintenanceTransaction[]> = {
  1: [
    { invoice: "MT05GL05", month: "May-2023", description: "Floor tiles & Marble work", workStatus: "Un-Complete", billStatus: "Un-Paid", billAmount: 44775 },
    { invoice: "MT05NC01", month: "Jan-2023", description: "Sanatory work", workStatus: "Completed", billStatus: "Paid", billAmount: 17135 },
    { invoice: "MT05NC12", month: "DEC-2022", description: "Fall ceiling repairs", workStatus: "Completed", billStatus: "Paid", billAmount: 57000 },
    { invoice: "DEP0523GUL", month: "May-2023", description: "Floor tiles & Marble work", workStatus: "Completed", billStatus: "Paid", billAmount: 44775 },
    { invoice: "DEP0523GUL", month: "May-2023", description: "Floor tiles & Marble work", workStatus: "Completed", billStatus: "Paid", billAmount: 44775 },
    { invoice: "DEP0523GUL", month: "May-2023", description: "Floor tiles & Marble work", workStatus: "Completed", billStatus: "Paid", billAmount: 44775 },
  ],
  2: [
    { invoice: "MT04RS01", month: "Apr-2023", description: "Painting & Wall repairs", workStatus: "Completed", billStatus: "Paid", billAmount: 32000 },
    { invoice: "MT03RS02", month: "Mar-2023", description: "Plumbing maintenance", workStatus: "Completed", billStatus: "Paid", billAmount: 15500 },
  ],
  3: [
    { invoice: "MT05SR01", month: "May-2023", description: "Electrical wiring fixes", workStatus: "In Progress", billStatus: "Un-Paid", billAmount: 28000 },
    { invoice: "MT04SR02", month: "Apr-2023", description: "Roof waterproofing", workStatus: "Completed", billStatus: "Paid", billAmount: 45000 },
  ],
  5: [
    { invoice: "MT05CM01", month: "May-2023", description: "HVAC system servicing", workStatus: "Completed", billStatus: "Paid", billAmount: 75000 },
    { invoice: "MT04CM02", month: "Apr-2023", description: "Elevator maintenance", workStatus: "Completed", billStatus: "Paid", billAmount: 120000 },
    { invoice: "MT03CM03", month: "Mar-2023", description: "Fire safety inspection", workStatus: "Completed", billStatus: "Paid", billAmount: 35000 },
  ],
  7: [
    { invoice: "MT05AP01", month: "May-2023", description: "Bathroom tile replacement", workStatus: "Un-Complete", billStatus: "Un-Paid", billAmount: 22000 },
  ],
  8: [
    { invoice: "MT05ST01", month: "May-2023", description: "Kitchen cabinet repairs", workStatus: "Completed", billStatus: "Paid", billAmount: 18000 },
  ],
  12: [
    { invoice: "MT05PT01", month: "May-2023", description: "Balcony railing repairs", workStatus: "In Progress", billStatus: "Un-Paid", billAmount: 35000 },
    { invoice: "MT04PT02", month: "Apr-2023", description: "Interior painting", workStatus: "Completed", billStatus: "Paid", billAmount: 85000 },
    { invoice: "MT03PT03", month: "Mar-2023", description: "Floor polishing", workStatus: "Completed", billStatus: "Paid", billAmount: 42000 },
  ],
};

export interface UtilityBillTransaction {
  date: string;
  billType: string;
  billStatus: "Paid" | "Un-Paid";
  billAmount: number;
...
export const utilityBillTransactions: Record<number, UtilityBillTransaction[]> = {
  1: [
    { date: "15-05-2023", billType: "Electric Bill", billStatus: "Un-Paid", billAmount: 775 },
    { date: "15-05-2023", billType: "Gas Bill", billStatus: "Paid", billAmount: 7135 },
    { date: "02-06-2023", billType: "Water Bill", billStatus: "Paid", billAmount: 570 },
    { date: "25-06-2023", billType: "Electric Bill", billStatus: "Paid", billAmount: 4775 },
    { date: "30-06-2023", billType: "Electric Bill", billStatus: "Paid", billAmount: 75 },
    { date: "05-07-2023", billType: "Electric Bill", billStatus: "Paid", billAmount: 970 },
  ],
  2: [
    { date: "10-05-2023", billType: "Electric Bill", billStatus: "Paid", billAmount: 12500 },
    { date: "10-05-2023", billType: "Gas Bill", billStatus: "Paid", billAmount: 3200 },
  ],
  3: [
    { date: "20-05-2023", billType: "Electric Bill", billStatus: "Un-Paid", billAmount: 8900 },
    { date: "20-05-2023", billType: "Water Bill", billStatus: "Paid", billAmount: 1200 },
  ],
  5: [
    { date: "01-05-2023", billType: "Electric Bill", billStatus: "Paid", billAmount: 45000 },
    { date: "01-05-2023", billType: "Gas Bill", billStatus: "Paid", billAmount: 18000 },
    { date: "01-06-2023", billType: "Electric Bill", billStatus: "Paid", billAmount: 52000 },
  ],
  7: [
    { date: "15-05-2023", billType: "Electric Bill", billStatus: "Un-Paid", billAmount: 3500 },
    { date: "15-05-2023", billType: "Water Bill", billStatus: "Un-Paid", billAmount: 800 },
  ],
  8: [
    { date: "10-05-2023", billType: "Electric Bill", billStatus: "Paid", billAmount: 2200 },
  ],
  12: [
    { date: "05-05-2023", billType: "Electric Bill", billStatus: "Paid", billAmount: 15000 },
    { date: "05-05-2023", billType: "Gas Bill", billStatus: "Paid", billAmount: 8500 },
    { date: "05-06-2023", billType: "Electric Bill", billStatus: "Paid", billAmount: 18000 },
  ],
};
