    ...
    <>
      <style>{`
        ...
        @media (max-width: 639px) {
          .maint-root      { height: auto; min-height: 100vh; overflow: visible; padding-bottom: 64px; }
          .maint-right     { height: auto; overflow: visible; }
          .maint-header    { padding: 14px 16px 5px; }
          .maint-breadcrumb { font-size: 14px; white-space: normal; }
          .maint-divider   { margin: 8px 14px; }
          .maint-card      { margin: 0 12px 16px; border-radius: 12px; }
          .maint-tabs      { gap: 4px; padding: 10px 8px; }
          .maint-tab       { padding: 7px 8px; min-width: 52px; }
          .maint-tab-label { font-size: 10px; }
          .maint-list      { padding: 4px 12px; }
          .maint-prop-card { gap: 8px; }
          .maint-prop-img  { width: 80px; height: 80px; border-radius: 8px; }
          .maint-prop-title { font-size: 16px; }
          .maint-prop-addr-text { font-size: 10px; }
          .maint-report-btn { width: 110px; font-size: 9px; height: 22px; }
        }

        @media (min-width: 640px) {
          .maint-header    { padding: 16px 40px 5px; }
          .maint-card      { margin: 0 44px 44px; }
          .maint-divider   { margin: 10px 32px; }
          .maint-tabs      { gap: 6px; padding: 16px 20px 14px; }
          .maint-tab       { padding: 10px 14px; min-width: 72px; }
          .maint-tab-label { font-size: 14px; }
          .maint-list      { padding: 6px 20px; }
          .maint-prop-img  { width: 102px; height: 102px; }
        }

        @media (min-width: 1024px) {
          .maint-header  { padding: 20px 100px 10px; }
          .maint-card    { margin: 0 120px 20px; }
          .maint-divider { margin: 10px 100px; }
          .maint-tabs    { gap: 8px; padding: 20px 24px 16px; }
          .maint-tab     { padding: 10px 16px; min-width: 80px; }
          .maint-tab-label { font-size: 14px; }
          .maint-list    { padding: 8px 24px; }
        }
      `}</style>
      ...
      <div className="maint-root">
        ...
        <div className="maint-right">
          ...
          <div className="maint-card">
            ...
            <div className="maint-list">
              {paginated.length === 0 ? (
                ...
                <div key={property.id} className="maint-prop-card">
                  {/* Image */}
                  <div className="maint-prop-img">
                    <img
                      src={property.image}
                      alt={property.title}
                  ...
                  {/* Info */}
                  <div className="maint-prop-info">
                    <div className="maint-prop-title-row">
                      <Image src="/line.png" alt="property icon" width={18} height={18} />
                      <span className="maint-prop-title">{property.title}</span>
                    </div>
                    <div className="maint-prop-addr">
                      <MdLocationOn size={13} color="#FE7A42" style={{ flexShrink: 0, marginTop: "1px" }} />
                      <span className="maint-prop-addr-text">{property.address}</span>
                    </div>
                  </div>

                  {/* Maintenance Report Button */}
                  <div className="maint-prop-right">
                    <Link href={`/maintenance/${property.id}`} style={{ textDecoration: "none" }}>
                      <button className="maint-report-btn">
                        <Image
                          src="/PdfRen.png"
                          alt="PDF"
                          width={14}
          ...
          <div className="maint-footer-illustration" />
        </div>
      </div>
    </>
  );
